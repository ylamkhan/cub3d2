...
/*   Updated: 2023/12/17 17:32:51 by ylamkhan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*ft_update(char *resirve)
{
	char	*new;
	int		i;
	int		j;
...
static char	*ft_remplire(char *str)
{
	char	*line;
	int		j;
...
static char	*ft_contuniresirve(int fd, char *resirve)
{
	char	*buffer;
	int		i;
